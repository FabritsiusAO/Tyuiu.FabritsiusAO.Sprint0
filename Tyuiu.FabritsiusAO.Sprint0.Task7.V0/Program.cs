using Tyuiu.FabritsiusAO.Sprint0.Task7.V0.Lib;

class programm
{
    static void Main(string[] args)
    {
        Console.Title = "Спринт #0 | Выполнил: Фабрициус А. О. | ИСТНб-24-1";
